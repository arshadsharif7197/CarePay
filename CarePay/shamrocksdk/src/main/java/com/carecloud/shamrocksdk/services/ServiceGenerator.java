...
import com.carecloud.shamrocksdk.services.interceptors.HeaderInterceptor;
import com.carecloud.shamrocksdk.services.interceptors.JSONFormattedLoggingInterceptor;
...
/**
 * This is a generic class use for API call using retrofit.
 * Any HTTP request will be created from this class.
 * Default header for HTTP request are added by default.
 * Default Base URL created from {@link HttpConstants}.
 */
