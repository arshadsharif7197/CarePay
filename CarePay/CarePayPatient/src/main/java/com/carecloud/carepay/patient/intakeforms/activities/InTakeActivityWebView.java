 ...
 */
public class InTakeActivityWebView extends BasePatientActivity {
    ...
    public String TAG = InTakeActivityWebView.class.getSimpleName();
    ...
    private WorkflowServiceCallback updateIntakeFormCallBack = new WorkflowServiceCallback() {
        ...
        public void onPostExecute(WorkflowDTO workflowDTO) {
            ...
            Intent intent = new Intent(InTakeActivityWebView.this, EligibilityActivity.class);
            startActivity(intent);
        }

        @Override
        public void onFailure(String exceptionMessage) {
            SystemUtil.showDialogMessage(InTakeActivityWebView.this, getString(com.carecloud.carepaylibrary.R.string.alert_title_server_error), exceptionMessage);
        }
    };
