...
//                        exportButton.setProgressEnabled(false);
    ...
    private void setUpUI(View view) {
        ...
        dateFromTextView.setOnClickListener(v -> showCalendar(FROM_DATE, dateFromTextView.getText().toString()));
        ...
        dateToTextView.setOnClickListener(v -> showCalendar(TO_DATE, dateToTextView.getText().toString()));
