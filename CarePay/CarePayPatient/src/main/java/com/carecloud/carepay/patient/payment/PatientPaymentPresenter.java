...
public class PatientPaymentPresenter extends PaymentPresenter
    ...
    public void onPaymentPlanAction(PaymentsModel paymentsModel) {
        ...
        PendingBalanceDTO reducedBalancesItem = reduceBalanceItems(selectedBalancesItem, paymentsModel.getPaymentPayload()
                .getActivePlans(getPracticeInfo(paymentsModel).getPracticeId()));
    ...
    public void onPaymentPlanAmount(PaymentsModel paymentsModel, PendingBalanceDTO selectedBalance, double amount) {
        ...
        if(mustAddToExisting(paymentsModel, amount, selectedBalance)){
    ...
    private boolean mustAddToExisting(PaymentsModel paymentsModel, double amount, PendingBalanceDTO selectedBalance) {
