...
public class StickHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void fixLayoutSize(ViewGroup parent, View view) {
        ...
        int childWidthSpec = ViewGroup.getChildMeasureSpec(widthSpec, parent.getPaddingLeft(), view.getLayoutParams().width);
        int childHeightSpec = ViewGroup.getChildMeasureSpec(heightSpec, parent.getPaddingTop(), view.getLayoutParams().height);
