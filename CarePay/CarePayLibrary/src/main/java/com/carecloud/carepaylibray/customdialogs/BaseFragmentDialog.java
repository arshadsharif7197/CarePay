...
public abstract class BaseFragmentDialog extends Dialog implements View.OnClickListener {
     ...
     */
    public BaseFragmentDialog(Context context, String cancelString, boolean isFooterVisible) {
        super(context);
