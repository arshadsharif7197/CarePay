...
public class VerifyActivity extends AppCompatActivity {
    ...
    private void reqEmailCode() {
        attrReqCode = "email";
        reqEmailVerf.setBackground(ContextCompat.getDrawable(VerifyActivity.this, R.drawable.button_selected));
    ...
    private void reqPhoneCode() {
        ...
        reqPhoneVerf.setBackground(ContextCompat.getDrawable(VerifyActivity.this, R.drawable.button_selected));
    ...
    private void sendVerfCode() {
        ...
        if(code == null) {
            ...
            verifCode.setBackground(ContextCompat.getDrawable(VerifyActivity.this, R.drawable.text_border_error));
            return;
        }
        ...
        verifCode.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    ...
                    verifCode.setBackground(ContextCompat.getDrawable(VerifyActivity.this, R.drawable.text_border_selector));
                }
            }
