...
public class PaymentConfirmationFragment extends BaseDialogFragment {
    ...
    public static PaymentConfirmationFragment newInstance(String paymentType,
                                                          String buttonLabel) {
        PaymentConfirmationFragment fragment = newInstance();
    ...
    public static PaymentConfirmationFragment newInstance(boolean isOneTimePayment) {
...
//        appointmentDTO = getAppointmentDto(workflowDTO);
    ...
    private AppointmentDTO getAppointmentDto(WorkflowDTO workflowDTO) {
        try {
            ...
            appointmentDTO = DtoHelper.getConvertedDTO(AppointmentDTO.class, workflowDTO.getPayload()
                    .getAsJsonObject("appointments"));
        }
        return null;
    }
    ...
    public void onViewCreated(View view, Bundle icicle) {
        ...
        okButton.setOnClickListener(closePopUpListener);
    ...
    private View.OnClickListener closePopUpListener = view -> {
        dismiss();
//            if (appointmentDTO != null) {
//                logAppointmentScheduledToMixPanel(appointmentDTO);
//            }
//            callback.completePaymentProcess(workflowDTO);
        viewModel.getFinishFlowObservable().postValue(null);
    };
    ...
    private void logAppointmentScheduledToMixPanel(AppointmentDTO appointmentDTO) {
        boolean isGuest = getApplicationMode().getApplicationType()
                .equals(ApplicationMode.ApplicationType.PRACTICE_PATIENT_MODE)
                && !ValidationHelper.isValidEmail(((ISession) getContext())
                .getAppAuthorizationHelper().getCurrUser());
